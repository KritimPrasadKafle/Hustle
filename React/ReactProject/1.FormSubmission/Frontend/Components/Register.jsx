    ...
    <div className='App'>
      ...
      <fieldset>
        <form action="#" method="get">
          ...
          <input type="tel" name="contact" value={contact} onChange={(e) => setContact(e.target.value)}
            placeholder="Enter Mobile Number" id="contact" required />
          ...
          <select name="select" id="select" value={selectedOption} onChange={(e) => setSelectedOption(e.target.value)}>
            ...
            <option value="" disabled
              selected={selectedOption === ""}>Select Your Ans</option>
